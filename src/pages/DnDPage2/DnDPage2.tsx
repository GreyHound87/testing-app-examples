...
const title = 'Задание: Сопоставление терминов с их определениями'
const description = 'Ваша задача — Соотнести каждый термин с его определением.'

export function DnDPage2() {
  return (
    <Card
      padding={16}
      borderRadius={16}
